    ...
    <div className="w-full min-h-screen  pt-[30px] pb-[60px]">
      {
        states.wishlistData.length === 0 ?
          <>
            <SharedEmptyCart slug="wishlist" imgURL="https://shopo-ecom.vercel.app/_next/image?url=https%3A%2F%2Fapi.websolutionus.com%2Fshopo%2Fuploads%2Fwebsite-images%2Fempty_wishlist-2022-11-17-11-23-16-9350.png&w=1920&q=75" />
          </> :
          <>

            ...
            <div className="flex flex-col justify-between h-full">
                ...
                <div className="saller-text-details">
                  <ul>
                    <li className="text-black flex space-x-5 items-center leading-9 text-base font-normal">
                      ...
                      <span>{props.sellerAdd.email}</span>
                    </li>
                    <li className="text-black flex space-x-5 items-center leading-9 text-base font-normal">
                      <span>
                        <svg
                      ...
                      <span>{props.sellerAdd.phone}</span>
                    </li>
                    <li className="text-black flex space-x-5 items-center leading-9 text-base font-normal">
                      <span>
                        <svg
              ...
              <div>
                <a
                  ...
                  href="/seller-products?seller=rayhans">
              ...
              <div className="flex sm:justify-center justify-start">
                <div className="w-[170px] h-[170px] rounded-full bg-white mb-[20px] flex justify-center items-center relative overflow-hidden">
                  <span
                    ...
                    <img
                      alt=""
                      src="/_next/image?url=https%3A%2F%2Fapi.websolutionus.com%2Fshopo%2Fuploads%2Fcustom-images%2Fseller-logo-2022-09-21-01-30-46-9044.png&amp;w=3840&amp;q=75"
                      decoding="async"
                      data-nimg="fill"
                      style={{
                        position: "absolute",

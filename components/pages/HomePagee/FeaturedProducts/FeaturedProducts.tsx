...
const FeaturedProducts: React.FC<Props> = (props) => {
  ...
  const [initialFeaturedProducts, setInitialFeaturedProducts] = useState<
    Array<IProduct>
  >([]);
  ...
  // }, [])
  const accessoriesProductFilter = () => {
    var newArray = states.featuredProducts.filter((el) => {
      return el.catSlug == "accessories_slug";
    });
    console.log("new", newArray);

            ...
            <div className='p-5 flex flex-col justify-between w-full bg-[#E7F2EC]'>
                <div className='flex space-x-5'>
                    ...
                    <div>
                        ...
                        <p className='text-[15px] text-qblack leading-[30px]'>Mirpur 11 ,Dhaka 1216 Bangladesh</p>
                    </div>
                </div>

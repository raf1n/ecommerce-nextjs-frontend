        ...
        <div className='w-full bg-qgrayBorder'>
            <div className='container-x mx-auto pb-[60px]'>
                ...
                <div className='tab-buttons w-full mb-10 mt-5 sm:mt-0'>
                    <div>
                        <ul className='flex space-x-12 '>
                            <li>
                                <span className='py-[15px] sm:text-[15px] text-sm sm:block border-b font-medium cursor-pointer border-qyellow text-qblack '>Description</span>
                            </li>
                            {/* <li>
                ...
                <div className='tab-contents w-full '>
                    <div>
                        <h6 className='text-[20px] font-bold text-qblack mb-5'>Introduction</h6>
                    ...
                    <div>
                        ...
                        <div className='text-qgray'>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla aut labore deleniti accusamus laboriosam? Eum non, ipsum sit debitis consectetur sunt ut autem dolore, molestiae est vel explicabo dignissimos voluptatibus.</p>
                        </div>
                    </div>
                </div>
            </div>

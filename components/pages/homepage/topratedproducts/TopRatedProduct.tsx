        ...
        <div>
            ...
            <div className='item w-full'>
                <div className='main-wrapper-card relative'>
                    <div data-aos="fade-left" className='product-row-card-style-one w-full lg:h-[250px] h-[200px] bg-white group relative overflow-hidden aos-init aos-animate'>
                            ...
                            <div className='lg:w-1/2 w-1/3 h-full relative transform scale-100 group-hover:scale-110 transition duration-300 ease-in-out'>
                                <span style={{
                                    ...
                                    <img decoding="async"
                                        ...
                                        className='w-full h-full object-contain' src={image} alt="" />
                                </span>
                            </div>
                            <div className='flex-1 flex flex-col justify-center h-full'>
                                <div>
                                    ...
                                    <a href="/single-product?slug=sony-joystick-sj-pro-vlv">
                                        <p className='title mb-2 sm:text-[15px] text-[13px] font-600 text-slate-700 font-semibold leading-[24px] line-clamp-2 hover:text-blue-600 cursor-pointer'>{name}</p>
                                    </a>

            ...
            <div className='container-x mx-auto pb-[60px]'>
                <div >
                    ...
                    <div className='grid lg:grid-cols-6 sm:grid-cols-4 grid-cols-2 '>
                        <div className='grid bg-white border border-primarygray place-items-center border-slate-200 h-32 px-5'><img src="https://shopo-ecom.vercel.app/_next/image?url=https%3A%2F%2Fapi.websolutionus.com%2Fshopo%2Fuploads%2Fcustom-images%2Foneplus-2022-09-25-04-15-53-8330.png&w=1920&q=75" alt="" /> </div>

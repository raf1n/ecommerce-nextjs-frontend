...
const items = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam fugit alias eos facilis aliquid ratione ut ea atque corporis quis dolore earum, voluptatum impedit? Facere blanditiis impedit ullam laborum sequi. ",
  },
  {
    id: 2,
    ...
    description:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus distinctio harum, error eum dolorum cum deleniti, quod nisi consequuntur possimus, atque sit nemo repellendus porro veniam animi ipsum voluptatibus at.",
  },
  {
    id: 3,
          ...
          <div
            ...
            <button
              ...
              <div className="flex justify-between items-center ">
                <div className="w-3/4 text-lg leading-5 font-medium text-qblack ">
                  {item.question}
                </div>
            ...
            {activeIndex === index && (
              <div className="rounded-b-md py-2 overflow-hidden 	">
                <div className=" py-3 text-qblack">{item.description}</div>
              </div>
            )}
          </div>
        ))}

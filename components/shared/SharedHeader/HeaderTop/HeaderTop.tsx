    ...
    <div>
      {sideDropdownOpen && (
        <div
          ...
          className="w-full h-screen bg-black bg-opacity-40 z-40 left-0 top-0 fixed"></div>
      )}
      {/* {sideDropdownOpen && ( */}
      <div
                    ...
                    <span>
                      <span>
                        <svg
                          ...
                          <path
                            fill="currentColor"
                            d="M420.5 301.9a24 24 0 1 1 24-24 24 24 0 0 1 -24 24m-265.1 0a24 24 0 1 1 24-24 24 24 0 0 1 -24 24m273.7-144.5 47.94-83a10 10 0 1 0 -17.27-10h0l-48.54 84.07a301.3 301.3 0 0 0 -246.6 0L116.2 64.45a10 10 0 1 0 -17.27 10h0l47.94 83C64.53 202.2 8.24 285.5 0 384H576c-8.24-98.45-64.54-181.8-146.9-226.6"></path>
                        </svg>
                      </span>
                    </span>
                    <span className="text-sm font-normal capitalize">
                    ...
                    <span>
                      <span>
                        <svg
                          ...
                          <path
                            fill="currentColor"
                            d="M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 64V448C362 448 448 362 448 256C448 149.1 362 64 256 64z"></path>
                        </svg>
                      </span>
                    </span>
                    <span className="text-sm font-normal capitalize">

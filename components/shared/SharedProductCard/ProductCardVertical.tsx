                                    ...
                                    <div className="flex space-x-1 mb-3">
                                        ...
                                        <span className="fill-qgray">
                                            <svg
                                                ...
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
                                                <path d='M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z fill="#none"'></path>
                                            </svg>
                                        </span>
                                        <span className="fill-qgray">
                                            <svg
                                                ...
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
                                                <path d='M9 0L11.0206 6.21885H17.5595L12.2694 10.0623L14.2901 16.2812L9 12.4377L3.70993 16.2812L5.73056 10.0623L0.440492 6.21885H6.97937L9 0Z fill="#D2D8E1"'></path>
                                            </svg>
                                        </span>
                                        <span className="fill-qgray">
                                            <svg
                            ...
                            >
                                <span className="w-10 h-10 flex text-black hover:text-white justify-center items-center transition-all duration-300 ease-in-out hover:bg-qyellow bg-primarygray rounded">
                                    <SvgIconRenderer
                                        ...
                                        className={"fill-current"}
                                        xmlns={"http://www.w3.org/2000/svg"}
                                        path={isInWishlist(product.slug) ? SvgPaths.filledHeart : SvgPaths.emptyHeart}

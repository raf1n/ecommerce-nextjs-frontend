...
const ProductCard: React.FC<Props> = (props) => {
  ...
  return (
    <div className={styles["item"]}>
      <div className={`${styles["lines"]} w-full h-[445px] bg-white relative group overflow-hidden`}
        style={{
      ...
      >
        ...
        <div className="product-card-details px-[30px] pb-[30px] relative pt-2">
          ...
          >
            <p className="title mb-2 text-[15px] font-semibold text-qblack leading-[24px] line-clamp-2 hover:text-blue-600 cursor-pointer break-words">
              {props.product.name}
            </p>
          </a>
          <p className="price">
